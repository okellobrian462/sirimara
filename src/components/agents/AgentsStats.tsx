                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24 max-w-5xl mx-auto">
                    {statistics.slice(0, 3).map((stat) => (
                        <div key={stat.id} className="text-center group">
                            <div className="text-7xl md:text-8xl lg:text-9xl font-light text-brand-dark mb-4 tracking-tighter transition-transform duration-500 group-hover:scale-105">
                                {stat.value}
                            </div>
