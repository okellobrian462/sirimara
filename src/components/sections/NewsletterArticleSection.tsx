...
export default function NewsletterArticleSection({ section }: NewsletterArticleSectionProps) {
    ...
    return (
        <section className="py-20 md:py-32 bg-white text-[#181728]">
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                <div
                    className="prose prose-lg max-w-none prose-headings:font-serif prose-headings:font-normal prose-p:font-light prose-p:leading-relaxed prose-a:text-[#181728] prose-a:underline hover:prose-a:opacity-70 transition-opacity"
