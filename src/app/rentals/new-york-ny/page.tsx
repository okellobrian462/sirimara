...
export default function RentalsSearchPage() {
    // Sample data extracted from user provided HTML
    const listings = [
        {
            id: 1,
        ...
        },
        {
            ...
            sqft: '3,952 SF',
            image: 'https://media.elliman.com/e9afee0d-fb1f-4224-a89b-144eb65e6bd1.jpg', // Using a placeholder/proxy url from context if exact matches fail, but trying best guess from html
            status: 'DOUGLAS ELLIMAN EXCLUSIVE',
            badge: 'LEASE SIGNED'
        },
        {
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            {/* Hero Section - Specific to Rentals Page as per screenshot */}
            <div className="bg-[#4d525c] pt-28 pb-16 text-center px-6"> {/* Using a dark grey/blue similar to screenshot */}
            ...
            <div className="flex h-[calc(100vh-250px)]">
                ...
                <div className="hidden lg:block w-2/5 bg-[#EAE8E4] relative overflow-hidden">
                    ...
                    <svg className="w-full h-full absolute inset-0 text-[#181728]" viewBox="0 0 100 100" preserveAspectRatio="none">
                        ...
                        />
                        {/* Just a decorative representation of map lines */}
                    </svg>
