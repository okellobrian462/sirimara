...
<p>Welcome to Sirimara Real Estate. Through the Sirimara Real Estate website, located at www.sirimara.com, and our affiliated sites, including without limitation ellimaninspirations.sirimara.com (collectively, the "Site"), you can browse and search real estate listings in our designated service areas.</p>
<p>Your use of the Site is subject to these Terms and Conditions of Use, which include the Privacy Policy, located at [url], ("Terms"). You must agree to these Terms before using the Site or any of the services offered through the Site (collectively, the "Service"). These Terms constitute a binding contract between Sirimara, LLC ("Sirimara", "we" or "us") and you ("you"). BY USING THE SITE, YOU AGREE TO THESE TERMS. IF YOU DO NOT AGREE TO THESE TERMS, PLEASE DO NOT ACCESS OR USE THE SITE.</p>
<p>We suggest that you print out a copy of these Terms for your records.</p>
<h3>1. REGISTRATION</h3>
<p>1. Scope of Use. The purpose of this Site is to assist customers and brokers in contacting Sirimara and its agents concerning the real estate rental and sales listings set forth herein and any other services offered by Sirimara. You represent that you are a prospective purchaser, seller, lessee or lessor of real property in the geographic areas where Sirimara is licensed and operating with a bona fide interest in the purchase, sale or lease of such real property.</p>
...
<p>4. Password and Identity. You may not share your password with anyone else. Any use of the Service through your Account will be deemed as being used by you. Sirimara is entitled to rely on the contact and other information that is supplied to us through your Account. Your Account is non-transferable and non-assignable.</p>
<p>5. Consent to Contact. BY REGISTERING FOR AN ACCOUNT, YOU CONSENT TO RECEIVE PERSONALIZED EMAILS, TELEPHONE CALLS AND/OR FAXES FROM DOUGLAS ELLIMAN. You must always provide accurate, current and complete information to Sirimara for the Service. You must update such information in a timely manner to maintain its accuracy and completeness.</p>
<p>6. Broker Restrictions. Any real estate broker, salesperson, agent, or similar state licensed real estate professional ("Real Estate Agent") who uses any Content for its customer must first enter into a co-brokerage agreement with Sirimara. We authorize the Real Estate Board of New York ("REBNY") and/or REBNY Listing Service ("RLS") brokers (and each of their duly authorized representatives) to access the Site for the purposes of verifying compliance with the provisions of these Terms, the Co-Brokerage Agreement between Sirimara...</p>
', 
  NULL, 
  'none', 
...
SELECT 
  ...
  NULL, 
  '<p><strong>Last Modified: 4/9/2025</strong></p>
<p>Sirimara Real Estate ("Sirimara", "we", "us" or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website www.sirimara.com and our affiliated sites (collectively, the "Site"). Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.</p>
...
VALUES 
  ('/terms-of-service', 'Terms of Service | Sirimara', 
   'Read our terms and conditions of use for the Sirimara website.', 
   ARRAY['terms', 'legal', 'conditions', 'use']),
  ('/privacy-policy', 'Privacy Policy | Sirimara', 
   'Learn how we protect your privacy at Sirimara.', 
